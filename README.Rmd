...
The underlying simulation engine can be easily adapted to run cohort-wide simulation, where the output statistics of interest are now global measures rather than dependent on the individual.
